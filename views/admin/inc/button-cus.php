...
<div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
      <div class="offcanvas-header align-items-start border-bottom flex-column border-translucent">
        <div class="pt-1 w-100 mb-6 d-flex justify-content-between align-items-start">
          <div>
            <h5 class="mb-2 me-2 lh-sm"><span class="fas fa-palette me-2 fs-8"></span>Tùy chỉnh chủ đề</h5>
            <p class="mb-0 fs-9">Khám phá các phong cách khác nhau theo sở thích của bạn</p>
        ...
        </div><button class="btn btn-phoenix-secondary w-100" data-theme-control="reset"><span class="fas fa-arrows-rotate me-2 fs-10"></span>Reset to mặc định</button>
      </div>
      <div class="offcanvas-body scrollbar px-card" id="themeController">
        ...
        <div class="border border-translucent rounded-3 p-4 setting-panel-item bg-body-emphasis">
          <div class="d-flex justify-content-between align-items-center">
            <h5 class="setting-panel-item-title mb-1">Trò chuyện hỗ trợ </h5>
        ...
        <div class="setting-panel-item">
          <h5 class="setting-panel-item-title">Chân trời</h5>
          <div class="row gx-2">
        ...
        <div class="setting-panel-item">
          <h5 class="setting-panel-item-title">Xuất hiện dọc theo chiều ngang</h5>
          <div class="row gx-2">
      ...
      <div class="card-body d-flex align-items-center px-2 py-1">
        ...
        </div><small class="text-uppercase text-body-tertiary fw-bold py-2 pe-2 ps-1 rounded-end">Tuỳ Chỉnh</small>
      </div>
    </a>
